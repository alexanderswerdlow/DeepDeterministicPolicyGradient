...
class RocketV2(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        ...
        mujoco_env.MujocoEnv.__init__(self, '/home/aswerdlow/UCLA/F21/EE209AS/RL/mujoco/rocket/envs/rocket_v2.xml', 5)
    ...
    def step(self, action):
        ...
        done = bool(np.any(pos, where=abs(pos) > 5).astype('bool') or pos[2] <= 0.07)
        if type(done) != bool:
            print(type(done))
        info = {
            'rp': reward_position,
